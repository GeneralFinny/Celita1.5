...
audio_file_path = "Alarm/beep.mp3"
...
if choice == "1":
    ...
    filipino_docs = open('Datasets/filipino_official.txt', encoding='utf-8').read().split("\n")
    cebuano_docs = open('Datasets/cebuano_official.txt', encoding='utf-8').read().split("\n")
